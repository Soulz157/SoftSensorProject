...
import { Phase3Results } from './pipeline/phase-3-results'

const STEP_LABELS = ['Select Dataset', 'Training Config', 'Results']
...
export function CreateModelForm() {
  ...
  // Results (3) is terminal with its own actions.
  const hideFooterNext = nav.currentStep === 3
    ...
    case 1:
      body = (
        <Phase1Details
          ...
          nameConflict={nav.nameConflict}
          selectedDataset={nav.selectedDataset}
          onName={setName}
          onDescription={setDescription}
          onWorkspace={changeWorkspace}
          onPlant={changePlant}
          onNode={setNodeId}
          onSelectDataset={nav.setSelectedDataset}
        />
      )
      break
    case 2:
        ...
        <div className="space-y-1">
          ...
          <p className="pl-8 text-sm text-muted-foreground">
            {isEdit
              ...
              : 'Pick a dataset, configure training, and review the results.'}
          </p>
        </div>

                ...
                {isCollapsed ? (
                  ...
                  <>
                    ...
                    <Button
                      ...
                      variant="outline"
                      size="sm"
                      className="w-full gap-2 h-8 text-xs border-dashed border-muted-foreground/30 text-muted-foreground hover:border-primary hover:text-primary transition-colors cursor-pointer"
                    >
